...
url(r'^action/information$', views.information,name="information_admin"),
url(r'^action/informationsuppr/(\d+)$', views.informationSuppr,name="informationsuppr_admin"),
url(r'^action/informationmodif/(\d+)$', views.informationModif,name="informationmodif_admin"),
...
url(r'^action/colleur/csv$', views.colleurcsv,name="csv_colleur"),
