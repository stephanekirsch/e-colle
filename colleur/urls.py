...
url(r'^action/groupe/creer/(\d+)$', views.groupeCreer,name="groupecreer_colleur"),
...
url(r'^action/colloscope/ajax/eleve/(\d+)/(\d+)/(\d+)/(\d+|semaine)/(\d+|creneau)/(\w{1,3})$', views.ajaxcolloscopeeleve,name="ajax_colleur_eleve"),
