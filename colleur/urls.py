...
url(r'^action/colloscope/ajax/eleve/(\d+)/(\d+)/(\d+)/(\d+|semaine)/(\d+|creneau)$', views.ajaxcolloscopeeleve,name="ajax_colleur_eleve"),
...
url(r'^action/colloscope/ajax/multi/(\d+|matiere)/(\d+|kolleur)/(\d+|groupe)/(\d+|semaine)/(\d+|creneau)/([1-9]{1}|[1-2]{1}[0-9]{1}|30|duree)/(1|2|3|4|8|frequence)/([1-9]{1}|1[0-9]{1}|20|permu)$', views.ajaxcolloscopemulti,name="ajaxmulti_colleur"),
url(r'^action/colloscope/ajax/multi/confirm/(\d+|matiere)/(\d+|kolleur)/(\d+|groupe)/(\d+|semaine)/(\d+|creneau)/([1-9]{1}|[1-2]{1}[0-9]{1}|30|duree)/(1|2|3|4|8|frequence)/([1-9]{1}|1[0-9]{1}|20|permu)$', views.ajaxcolloscopemulticonfirm,name="ajaxmulticonfirm_colleur"),
