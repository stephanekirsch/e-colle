...
CHEMINVERSECOLLE='/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/e-colle' # chemin absolu vers l'intérieur du répertoire e-colle
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': 8, # longueur minimale des mots de passe
        }
    },
    {
