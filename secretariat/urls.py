...
url(r'^action/information$', views.information,name="information_secret"),
url(r'^action/informationsuppr/(\d+)$', views.informationSuppr,name="informationsuppr_secret"),
url(r'^action/informationmodif/(\d+)$', views.informationModif,name="informationmodif_secret"),
url(r'^action/notes$', views.notes, name="notes_secret"),
url(r'^action/colloscope/([0-1]{1})/(\d+)$', views.colloscope, name="colloscope_secret"),
url(r'^action/colloscope/([0-1]{1})/(\d+)/(\d+)/(\d+)$', views.colloscope2, name="colloscope2_secret"),
url(r'^action/colloscopepdf/(\d+)/(\d+)/(\d+)$', views.colloscopePdf, name="colloscopepdf_secret"),
url(r'^action/colloscopecsv/(\d+)/(\d+)/(\d+)$', views.colloscopeCsv, name="colloscopecsv_secret"),
url(r'^action/colloscope/modifier/(\d+)/(\d+)/(\d+)$', views.colloscopeModif,name="colloscopemodif_secret"),
url(r'^action/colloscope/importer/(\d+)$', views.colloscopeImport,name="importcolloscope_secret"),
...
url(r'^action/colloscope/ajax/eleve/(\d+)/(\d+)/(\d+)/(\d+|semaine)/(\d+|creneau)/(\w{1,3})$', views.ajaxcolloscopeeleve,name="ajax_secret_eleve"),
...
url(r'^action/groupe/creer/(\d+)$', views.groupeCreer,name="groupecreer_secret"),
...
url(r'^action/ramassage/csv/(\d+)/(\d+)/(\d+)$', views.ramassageCSV, name="ramassagecsv"),
url(r'^action/ramassage/pdfparclasse/(\d+)/(\d+)/(\d+)$', views.ramassagePdfParClasse, name="ramassagepdfparclasse"),
url(r'^action/ramassage/csvparclasse/(\d+)/(\d+)/(\d+)$', views.ramassageCSVParClasse, name="ramassagecsvparclasse"),
