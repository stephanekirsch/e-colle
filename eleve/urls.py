...
re_path(r'^action/planches$', views.planches ,name="eleve_planches"),
re_path(r'^action/planches/ajout/(\d+)$', views.plancheAjout ,name="eleve_planche_ajout"),
re_path(r'^action/planches/suppr/(\d+)$', views.plancheSuppr ,name="eleve_planche_suppr"),
re_path(r'^action/planches/modif/(\d+)$', views.plancheModif ,name="eleve_planche_modif"),
